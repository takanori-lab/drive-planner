...
Google Maps APIやAPIキーを使わず、通常のGoogle Maps URLsで外部連携します。地点・候補をGoogleマップで探し、コピーした共有URLを保存して登録済みの場所を開けます。また、区間ごとの自動車経路をGoogleマップで開けます（ドライブ全体のルート表示や地図の埋め込みは行いません）。
